...
namespace Sp.Transpak.TranspakArchiveMessage
{
    ...
    [System.Runtime.InteropServices.Guid("84a4bc4d-ab50-48ef-841d-51745bcbaef6")]
    public class TranspakArchivePipelineComponent :
         IBaseComponent,
         ...
         IComponentUI
    {
        ...
        public string Name
        {
            get
            {
                return "Transpak Archive Message";
            }
        }
        [Browsable(false)]
        ...
        public string Description
        {
            get
            {
                return "Transpak Archive Message Pipeline Component";
            }
        }
        [Browsable(false)]
        ...
        private System.Resources.ResourceManager resourceManager =
            new System.Resources.ResourceManager(
                    "Sp.Transpak.TranspakArchiveMessage.TranspakArchiveMessage_Component",
            ...
            Microsoft.BizTalk.Message.Interop.IBaseMessage pInMsg)
        {
            ...
            myLog.Source = "TranspakArchiveMessage";
