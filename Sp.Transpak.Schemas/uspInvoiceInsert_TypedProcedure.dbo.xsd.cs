namespace Sp.Transpak.Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Sp.Transpak.Schemas.uspInvoiceInsert_TableType_dbo", typeof(global::Sp.Transpak.Schemas.uspInvoiceInsert_TableType_dbo))]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Sp.Transpak.Schemas.uspInvoiceInsert_ProcedureResultSet_dbo_InterfaceInvoiceInsert", typeof(global::Sp.Transpak.Schemas.uspInvoiceInsert_ProcedureResultSet_dbo_InterfaceInvoiceInsert))]
    public sealed class uspInvoiceInsert_TypedProcedure_dbo : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:ns3=""http://schemas.microsoft.com/Sql/2008/05/Types/TableTypes/dbo"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns4=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/InterfaceInvoiceInsert"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.microsoft.com/Sql/2008/05/TypedProcedures/dbo"" version=""1.0"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:import schemaLocation=""Sp.Transpak.Schemas.uspInvoiceInsert_TableType_dbo"" namespace=""http://schemas.microsoft.com/Sql/2008/05/Types/TableTypes/dbo"" />
  <xs:import schemaLocation=""Sp.Transpak.Schemas.uspInvoiceInsert_ProcedureResultSet_dbo_InterfaceInvoiceInsert"" namespace=""http://schemas.microsoft.com/Sql/2008/05/ProceduresResultSets/dbo/InterfaceInvoiceInsert"" />
  <xs:annotation>
    <xs:appinfo>
  ...
  <xs:element name=""InterfaceInvoiceInsert"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs=""0"" maxOccurs=""1"" name=""InvAttachmentsType"" nillable=""true"" type=""ns3:ArrayOfInvoiceAttachmentsTableType"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
  <xs:element name=""InterfaceInvoiceInsertResponse"">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        public uspInvoiceInsert_TypedProcedure_dbo() {
        }
